...
const hiTranslations = {
  ...
  patients: {
    ...
    patientCreatedSuccess: 'रोगी सफलतापूर्वक बना दिया गया है',
  ...
  prescriptions: {
    ...
    prescribedFor: 'के लिए निर्धारित',
    managePrescriptions: 'रोगी नुस्खे बनाएं और प्रबंधित करें',
    noMedicationsAdded: 'इस नुस्खे में कोई दवाएं नहीं जोड़ी गई हैं',
  ...
  records: {
    ...
    searchPlaceholder: 'रोगी या निदान द्वारा खोजें',
    noFilesUploaded: 'अभी तक कोई फाइल अपलोड नहीं की गई है',
  ...
  billing: {
    ...
    patientRequired: 'रोगी आवश्यक है',
    dueDateRequired: 'भुगतान तिथि आवश्यक है',
    descriptionRequired: 'विवरण आवश्यक है',
    quantityRequired: 'मात्रा आवश्यक है',
    unitPriceRequired: 'इकाई मूल्य आवश्यक है',
    itemsRequired: 'कम से कम एक आइटम आवश्यक है',
    created: 'चालान बनाया गया',
    updated: 'चालान अपडेट किया गया',
    createSuccess: 'चालान सफलतापूर्वक बनाया गया है',
    updateSuccess: 'चालान सफलतापूर्वक अपडेट किया गया है',
    item: 'आइटम',
    selectStatus: 'स्थिति चुनें',
    selectDueDate: 'भुगतान तिथि चुनें',
    notesPlaceholder: 'अतिरिक्त नोट्स या भुगतान जानकारी',
    noItemsAdded: 'इस चालान में कोई आइटम नहीं जोड़ा गया है',
    ...
    statusUpdateSuccess: 'चालान स्थिति सफलतापूर्वक अपडेट की गई है',
...
// Assamese translations (simplified to avoid encoding issues)
